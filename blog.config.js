...
const BLOG = {
  ...
  THEME_SWITCH: process.env.NEXT_PUBLIC_THEME_SWITCH || true [ta], // 是否显示切换主题按钮
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，这里是龙珠漫画考古站, Hi，这里是龙珠原著博物馆, Hi，这里是鸟山明的漫画世界, 欢迎来到我的个人空间🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Y2O3', // 您的昵称 
  BIO: process.env.NEXT_PUBLIC_BIO || '《龙珠》入门，曳尾涂中', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-peach-phi-85.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '龙珠, 漫画, 鸟山明', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'y2o3mip@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  IMAGE_COMPRESS_WIDTH: process.env.NEXT_PUBLIC_IMAGE_COMPRESS_WIDTH || 702, // 图片压缩宽度默认值，作用于博客封面和文章内容 越小加载图片越快
  IMAGE_ZOOM_IN_WIDTH: process.env.NEXT_PUBLIC_IMAGE_ZOOM_IN_WIDTH || 1404, // 文章图片点击放大后的画质宽度，不代表在网页中的实际展示宽度
